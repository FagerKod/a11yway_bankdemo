      ...
      <div className="max-w-2xl mx-auto px-4">
        <article className="bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Vårt tillgänglighetsarbete</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Standarder vi följer</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Rapportera problem</h2>
              <p>
                Upplever du tillgänglighetsproblem? Kontakta oss på
                tillganglighet@demobanken.se så åtgärdar vi det så snart som möjligt.
              </p>
            </section>
          </div>
