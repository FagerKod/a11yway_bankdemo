      ...
      <div className="max-w-2xl mx-auto px-4">
        <article className="bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Allmänna villkor</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Ansvar</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-navy-900 mb-2">Personuppgifter</h2>
              <p>
